...
export class BlockBoundary extends Component {
    ...
    render() {
        return this.state.failed
            ? _jsxs("div", { className: css.notice, children: ["\u6B64\u5185\u5BB9\u6682\u65F6\u65E0\u6CD5\u5728\u9605\u8BFB\u9875\u663E\u793A\uFF1B\u539F\u5BF9\u8BDD\u4E2D\u7684\u8BB0\u5F55\u672A\u53D7\u5F71\u54CD\u3002", _jsxs("span", { "data-reader-block-error": true, style: { opacity: .65 }, children: ["\uFF08", this.state.detail, "\uFF09"] })] })
            : this.props.children;
    }
}
...
export function CopyAnswer({ blocks, onFork, metrics, extraActions }) {
    ...
    if (!text.trim() && !onFork && !hasMetrics)
        return null;
    return _jsxs("div", { className: css.answerActions, children: [text.trim() !== '' && (_jsx("button", { type: "button", className: css.iconButton, "aria-label": "\u590D\u5236\u56DE\u7B54", title: "\u590D\u5236\u56DE\u7B54", onClick: () => { void copy(text); }, children: _jsx(CopyGlyph, {}) })), onFork && (_jsx("button", { type: "button", className: css.iconButton, "aria-label": "\u4EE5\u6B64\u5904\u4E3A\u57FA\u7840\u521B\u5EFA\u5206\u53C9\u4F1A\u8BDD", title: "\u4EE5\u6B64\u5904\u4E3A\u57FA\u7840\u521B\u5EFA\u5206\u53C9\u4F1A\u8BDD (Fork)", onClick: onFork, children: _jsxs("svg", { viewBox: "0 0 16 16", width: "14", height: "14", fill: "none", stroke: "currentColor", strokeWidth: "1.2", children: [_jsx("circle", { cx: "4.5", cy: "3.5", r: "1.8" }), _jsx("circle", { cx: "4.5", cy: "12.5", r: "1.8" }), _jsx("circle", { cx: "11.5", cy: "5.5", r: "1.8" }), _jsx("path", { d: "M4.5 5.5v5M4.5 8c2.5 0 4.5-1 7-2.5", strokeLinecap: "round" })] }) })), metrics && _jsx(TurnMetrics, { usage: metrics.usage, runMs: metrics.runMs, tokensPerSecond: metrics.tokensPerSecond, ttftMs: metrics.ttftMs }), endedAt !== undefined && _jsx(MessageClock, { time: endedAt }), extraActions, _jsx("span", { role: "status", className: css.meta, children: receipt })] });
}
export function UserMessageActions({ text, time }) {
    ...
    if (!hasText && time === undefined)
        return null;
    return _jsxs("div", { className: css.userActions, children: [time !== undefined && _jsx(MessageClock, { time: time }), hasText && (_jsx("button", { type: "button", className: css.iconButton, "aria-label": "\u590D\u5236\u6D88\u606F", title: "\u590D\u5236\u6D88\u606F", onClick: () => { void copy(text); }, children: _jsx(CopyGlyph, {}) })), _jsx("span", { role: "status", className: css.meta, children: receipt })] });
}
