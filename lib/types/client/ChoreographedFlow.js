...
function Summary({ item, open, onChange, motion }) {
    ...
    return _jsx("div", { "data-reader-live-fold": true, "data-expanded": open, "data-reader-live-fold-summary": item.summary, children: _jsx(Disclosure, { open: open, onChange: onChange, buttonRef: button, ariaLabel: "\u6B64\u524D\u6B65\u9AA4", label: _jsx(FoldSummaryText, { summary: item.summary, motion: motion }) }) });
}
