 ...
 * fallback still show.
 */
export declare function OfficialNode({ renderSlot, node, cwd, openFile, inspectCall, forkAt, loadImage, officialFileMentions, fallback, }: Pick<BlockRenderProps, 'renderSlot' | 'openFile' | 'forkAt'> & {
...
//# sourceMappingURL=OfficialNode.d.ts.map