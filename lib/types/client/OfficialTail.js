 ...
 */
export function OfficialTail({ renderSlot, turn, seq, openFile, producedPaths, }) {
    const owner = {
        turn,
        seq,
    ...
    return _jsx("div", { "data-reader-official-tail": true, style: { display: 'contents' }, children: renderSlot(OFFICIAL_SEATS.tail, owner) });
}
//# sourceMappingURL=OfficialTail.js.map