...
const MainNode = memo(function MainNode({ useChat, nodeKey, boundary, pinned, processOpen = false, ...render }) {
    ...
    if (node.kind === 'context' || node.kind === 'turn-tail' || node.kind === 'system-prompt' || node.kind === 'turn-process')
        return null;
    if (node.kind === 'command-input') {
        const data = node.data;
        return _jsxs("div", { className: css.user, "data-reader-anchor": true, "data-reader-key": nodeKey, children: [_jsx("p", { className: css.meta, children: "\u547D\u4EE4\u8F93\u5165" }), _jsx("p", { className: css.commandInput, children: data.text })] });
    }
...
export function Reader(props) {
    ...
    return _jsx(StreamMotionContext.Provider, { value: streamMotion, children: _jsxs("div", { ref: root, className: css.root, "data-dsh-better-display": "0.3.0", "data-reader-wait-clock-version": "input-v1", "data-reader-wait-start": waitAnchor.time ?? undefined, "data-motion": motion ? 'on' : 'off', children: [_jsx(TimelineRail, { items: timelineItems, activeTurn: activeTurn, busyTurn: busyTurn, onNavigate: onNavigateTurn }), _jsxs("div", { className: css.column, "data-chat-flow": "", children: [_jsxs(StickyLane, { kind: "toolbar", className: css.toolbar, children: [_jsx("button", { type: "button", className: css.textButton, "aria-pressed": autoFold, onClick: () => props.actions.setAutoFold(!autoFold), title: "\u65B0\u601D\u8003\u4EA7\u751F\u65F6\uFF0C\u662F\u5426\u81EA\u52A8\u5C06\u6B64\u524D\u6B65\u9AA4\u6536\u62E2\u4E3A\u4E00\u884C\u6C47\u603B\u3002\u5173\u95ED\u540E\u5B8C\u6574\u4FDD\u7559\u539F\u59CB\u8FC7\u7A0B\u4E0E\u6D41\u5F0F\u8F93\u51FA\u3002", children: `自动折叠${autoFold ? '开' : '关'}` }), _jsx("button", { type: "button", className: css.textButton, "aria-pressed": motionPreference, onClick: () => props.actions.setMotion(!motionPreference), title: "\u65B0\u5230\u6587\u5B57\u67D4\u548C\u663E\u73B0\uFF0C\u8FC7\u7A0B\u5E73\u6ED1\u5C55\u5F00\uFF1B\u5173\u95ED\u540E\u7ACB\u5373\u5B8C\u6574\u663E\u793A\uFF0C\u81EA\u52A8\u9075\u5FAA\u7CFB\u7EDF\u51CF\u5C11\u52A8\u6001\u6548\u679C\u8BBE\u7F6E\u3002", children: motionPreference && !motion ? '动效 · 跟随系统关闭' : `动效${motionPreference ? '开' : '关'}` })] }), hasMore && _jsx("button", { type: "button", className: css.historyButton, disabled: loadingOlder, onClick: async () => {
