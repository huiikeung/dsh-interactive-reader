...
export function ReasoningCard({ children, step, active, motion, selected, onRead }) {
    ...
    return _jsxs("div", { className: css.reasonCard, "data-reader-reasoning-card": true, "data-reader-anchor": true, "data-expanded": expanded, "data-following": allowed, "data-overflow": overflow, "data-ud-motion": "reader-reasoning-size", children: [_jsxs("div", { className: css.reasonHeading, "data-reader-reasoning-heading": true, "data-ud-check": "reasoning-identity", children: [_jsx("span", { className: css.reasonLabel, "data-reader-reasoning-label": true, children: "\u601D\u8003" }), _jsxs("span", { children: ["\u6B65\u9AA4 ", step] })] }), _jsx("div", { ref: viewport, id: controls, className: css.reasonViewport, "data-reader-reasoning-scroll": true, "data-edges": edges, "data-ud-motion": "reader-reasoning-scroll", role: "region", "aria-label": `步骤 ${step} 的思考${overflow ? '，可滚动阅读' : ''}`, tabIndex: overflow ? 0 : undefined, onPointerDown: pause, onFocus: pause, children: _jsx("div", { ref: track, className: css.reasonTrack, "data-reader-reasoning-track": true, children: _jsx("div", { ref: content, className: css.reasonText, "data-reader-reasoning-text": true, children: children }) }) }), (overflow || expanded) && _jsxs("div", { className: css.reasonFooter, "data-ud-check": "reasoning-controls", children: [active && motion ? _jsxs("button", { type: "button", className: css.reasonAction, disabled: selected, "aria-controls": controls, "aria-label": following ? '暂停自动跟随思考' : '继续跟随最新思考', title: selected ? '取消文字选择后可继续跟随' : undefined, onClick: () => { if (following)
                            pause();
                        else {
                            onRead();
                            setFollowing(true);
                        } }, children: [_jsx("svg", { width: "12", height: "12", viewBox: "0 0 16 16", "aria-hidden": "true", children: following ? _jsx("path", { d: "M5.5 4v8m5-8v8" }) : _jsx("path", { d: "M8 3v10m-4-4 4 4 4-4" }) }), following ? '暂停跟随' : '跟随最新'] }) : _jsx("span", { className: css.reasonCaption, children: expanded ? '手动阅读' : '可滚动阅读' }), _jsxs("button", { type: "button", className: css.reasonAction, "aria-expanded": expanded, "aria-controls": controls, "aria-label": expanded ? '收起完整思考' : '展开阅读完整思考', onClick: toggleReading, children: [expanded ? '收起' : '展开阅读', _jsx("svg", { width: "12", height: "12", viewBox: "0 0 16 16", "aria-hidden": "true", children: expanded ? _jsx("path", { d: "m4 10 4-4 4 4" }) : _jsx("path", { d: "m4 6 4 4 4-4" }) })] })] })] });
}
