...
export const TurnMetrics = memo(function TurnMetrics({ usage, runMs, tokensPerSecond, ttftMs, }) {
    ...
    const updatePopupPlacement = useCallback(() => {
        ...
        const placement = spaceBelow < estimatedPopupHeight ? 'below' : 'above';
