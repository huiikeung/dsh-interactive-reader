...
export function installFolderPane(ctx) {
    ...
    ctx.effect(() => tabs.register(folderTabDefinition), 'dsh-better-display: folder pane tab type');
    ...
    }, FolderPaneBody)), 'dsh-better-display: folder pane body');
}
