...
export function ContextInjectionRow({ content, source, producer, form, t }) {
    ...
    return (_jsx(DisclosureRow, { className: css.root, icon: producer.role === 'recall'
            ...
            : _jsx(IconBrowseOutline16, { size: 14 }), chevronClassName: css.chevron, title: t(producer.role === 'recall' ? 'message.contextRecall' : 'message.contextInjection'), collapsedContent: producer.label === null ? undefined : (_jsxs(_Fragment, { children: [_jsx("span", { className: css.sep, "aria-hidden": true }), _jsx("span", { className: css.source, "data-context-source": true, children: producer.label }), summary !== null && (_jsxs(_Fragment, { children: [_jsx("span", { className: css.sep, "aria-hidden": true }), _jsx("span", { className: css.summary, "data-context-summary": true, children: summary })] }))] })), keepContentWhenOpen: true, open: open, expandable: true, expandOnRowClick: true, onToggle: () => { setOpen(value => !value); }, children: _jsx("div", { className: css.body, "data-context-injection-body": true, "data-context-form": rendered ?? undefined, children: body }) }));
}
