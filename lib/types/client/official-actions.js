 ...
 */
export function mirrorOfficialActions(registry) {
    const mounted = new Map();
    let stopped = false;
    const disposeEntry = (entry, dispose) => {
        dispose();
 ...
 */
export function installOfficialActions(ctx) {
...
//# sourceMappingURL=official-actions.js.map