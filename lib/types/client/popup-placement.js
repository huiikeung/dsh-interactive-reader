...
export function popupLayoutFor(args) {
    ...
    const placement = spaceAbove < POPUP_ESTIMATED_HEIGHT && spaceBelow > spaceAbove ? 'below' : 'above';
    const left = Math.max(POPUP_GAP, Math.min(args.triggerLeft, args.viewportWidth - POPUP_PANEL_WIDTH - POPUP_GAP));
...
//# sourceMappingURL=popup-placement.js.map