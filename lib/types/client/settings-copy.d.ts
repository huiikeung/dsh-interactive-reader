export type SettingsCopyKey = 'nav' | 'sectionSubtitle' | 'openTitle' | 'openDescription' | 'glassTitle' | 'glassDescription' | 'foldTitle' | 'foldDescription' | 'foldNone' | 'foldStandard' | 'foldSummary' | 'fnosTitle' | 'fnosDescription' | 'fnosPlaceholder' | 'fnosTokens' | 'skillTitle' | 'skillInstalled' | 'skillMissing' | 'skillPurpose' | 'skillPluginNote' | 'skillInstall' | 'skillRecheck' | 'skillChecking' | 'skillUnavailable';
