...
if (!process.argv[2] || !existsSync(join(root, 'packages/client/web/src/platform.ts'))) throw new Error('Pass a prepared Harness checkout.');
...
link('lightningcss', dirname(dirname(rootRequire.resolve('lightningcss'))));
